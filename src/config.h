// config.h — compile-time constants for smalltv-ultra
//
...
// Release asset the GitHub self-updater pulls — one app image per target.
  ...
  #define UPDATE_ASSET "smalltv-ultra-firmware-esp32.bin"
#else
  #define UPDATE_ASSET "smalltv-ultra-firmware.bin"
#endif
...
// ---------------------------------------------------------------------------
// Compile-time feature toggles. All shipping features are on by default.
// ---------------------------------------------------------------------------
#ifndef WITH_TICKER
...
#endif
#ifndef WITH_GALLERY
#define WITH_GALLERY 1
#endif

#define MAX_PHOTOS 16
...
// ---------------------------------------------------------------------------
#define DEFAULT_AP_SSID      "GeekTV-Setup"
#define DEFAULT_AP_PASS      ""              // empty => open AP
#define DEFAULT_HOSTNAME     "geektv"
