// UsageMode.h — Antigravity + Codex usage meter.
//
// Shows two usage bars + a small mascot when data is flowing, and an animated
// pixel-art mascot when the bridge goes quiet. Owns its fetch (UsageClient), its
